create or replace function public.admin_save_test_mode(
  p_enabled boolean,
  p_allow_admin_user_login boolean,
...
revoke all on function public.admin_save_test_mode(boolean, boolean, text, text, integer)
  from public, anon, authenticated;
grant execute on function public.admin_save_test_mode(boolean, boolean, text, text, integer)
  to service_role;
