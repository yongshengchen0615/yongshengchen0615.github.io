...
assert.match(calendarFlow, /\$\{interval\.startTime\}–\$\{interval\.endTime\}/);
assert.doesNotMatch(calendarFlow, /\$\{interval\.startTime\}–\$\{interval\.endTime\} 我的預約/);
...
assert.ok(bookingIndex.includes('calendar-flow.js?v=test-mode-20260920-1'));
