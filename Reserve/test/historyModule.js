...
export const HistoryModule = (() => {
    ...
    function renderHistoryList(containerSelector) {
        ...
        history.forEach((record, index) => {
            ...
            button.innerHTML = `${summary} ｜ ⏳ ${totalTime} 分｜💰 $${totalPrice} 元`;
            ...
            body.className = "accordion-body bg-light rounded shadow-sm p-3";
    
            const detailDiv = document.createElement("div");
            detailDiv.className = "mb-3 small text-muted border-start ps-3";
            detailDiv.innerHTML = details;
    
            const btnGroup = document.createElement("div");
            btnGroup.className = "d-flex gap-2 justify-content-end flex-wrap";
    
            const baseBtnClass = "btn btn-sm px-3 rounded-pill fw-semibold";
    
            const restoreBtn = document.createElement("button");
            restoreBtn.className = `${baseBtnClass} btn-outline-primary`;
