...
$(document).ready(async function () {
    ...
    // ✅ 測試用假資料產生並立即還原
    $("#btn-generate-test").on("click", () => {
        BookingStorageModule.generateTestData();        // 儲存假資料
        const testData = BookingStorageModule.load();   // 重新載入
        BookingStorageModule.restoreToForm(testData);   // 還原到表單
    });
});
