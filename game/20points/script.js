// 定義獎項及其出現機率（總和需為 100）
const prizePool = [
    { prize: "🔸 身體按摩券 💆 x2", probability: 5 }, 
    { prize: "🔸 腳底按摩券 🦶 x2", probability: 5 },  
    { prize: "🔸 200元回饋金", probability:  30}, 
    { prize: "🔸 100元回饋金", probability: 30 }, 
    { prize: "🔸 甜湯 / 雞湯 🍵", probability: 10 }, 
    { prize: "🔸 基底精油 1 瓶 🌿", probability: 10 }, 
    { prize: "🔸 複方精油 1 瓶 🌸", probability: 10 }, 
