...
window.TURN_ADMIN_CONFIG = {
  ...
  scriptUrl: 'https://script.google.com/macros/s/AKfycbzXUesyCQXq63_9zWQm0B7dfLvZ4me3n4frQots_RXX6XYNrzr8YC1cSM2Ojlgv1X2e/exec',
  // 預設工作表名稱（必填）
  sheetName: '機率',
  // 代理（選填），若不需要請留空字串
  proxyUrl: '',
  ...
  liff: {
    // 請填入 15 點活動自己的 LIFF ID，endpoint: /lottery/turntable/15points/index.html
    liffId: '2005939681-87tUHNK2',
