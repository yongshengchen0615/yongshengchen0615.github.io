...
test('event ticket bootstrap exposes the member tier and the remaining time to the next tier', () => {
...
test('event ticket browser and admin contracts are present', () => {
  ...
  assert.match(adminHtml, /app\.js\?v=admin-login-progress-20260908/);
  ...
  assert.match(eventHtml, /app\.js\?v=event-login-progress-20260908/);
