...
const MEMBERSHIP_SHEET_SCHEMAS_ = Object.freeze({
  ...
  CalendarItems: Object.freeze(['calendar_item_id', 'title', 'item_type', 'description', 'starts_on', 'ends_on', 'status', 'accent', 'created_by', 'created_at', 'updated_by', 'updated_at', 'allowed_tier_keys']),
