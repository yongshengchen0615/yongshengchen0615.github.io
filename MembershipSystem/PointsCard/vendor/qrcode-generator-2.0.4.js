...
var qrcode = function() {
  ...
  var qrNumber = function(data) {
    ...
    var strToNum = function(s) {
      var num = 0;
      for (var i = 0; i < s.length; i += 1) num = num * 10 + chatToNum(s.charAt(i) );
      return num;
    };
  ...
  var qrKanji = function(data) {
    ...
    var _this = {};
    _this.getMode = function() { return _mode; };
    _this.getLength = function() { return ~~(_bytes.length / 2); };
    _this.write = function(buffer) {
      var data = _bytes;
      var i = 0;
  ...
  var byteArrayOutputStream = function() {
    var _bytes = [];
    var _this = {};
    _this.writeByte = function(b) { _bytes.push(b & 0xff); };
    _this.writeShort = function(i) { _this.writeByte(i); _this.writeByte(i >>> 8); };
    _this.writeBytes = function(b, off, len) {
      off = off || 0;
      len = len || b.length;
      for (var i = 0; i < len; i += 1) _this.writeByte(b[i + off]);
    };
    _this.writeString = function(s) { for (var i = 0; i < s.length; i += 1) _this.writeByte(s.charCodeAt(i) ); };
    _this.toByteArray = function() { return _bytes; };
    _this.toString = function() { return '[' + _bytes.join(',') + ']'; };
    return _this;
  };
  ...
  var base64EncodeOutputStream = function() {
    ...
    var _base64 = '';
    var _this = {};
    var writeEncoded = function(b) { _base64 += String.fromCharCode(encode(b & 0x3f) ); };
    ...
    _this.flush = function() {
      ...
      if (_length % 3 != 0) {
        ...
        for (var i = 0; i < padlen; i += 1) _base64 += '=';
      }
    };
    _this.toString = function() { return _base64; };
    return _this;
  };
  ...
  var gifImage = function(width, height) {
    ...
    var _this = {};
    _this.setPixel = function(x, y, pixel) { _data[y * _width + x] = pixel; };
    _this.write = function(out) {
      ...
      out.writeByte(0xff); out.writeByte(0xff); out.writeByte(0xff);
      out.writeString(',');
      out.writeShort(0); out.writeShort(0); out.writeShort(_width); out.writeShort(_height); out.writeByte(0);
    ...
    var bitOutputStream = function(out) {
      ...
      _this.flush = function() { if (_bitLength > 0) _out.writeByte(_bitBuffer); };
      return _this;
    };
    ...
    var getLZWRaster = function(lzwMinCodeSize) {
      ...
      var table = lzwTable();
      for (var i = 0; i < clearCode; i += 1) table.add(String.fromCharCode(i) );
    ...
    var lzwTable = function() {
      ...
      _this.size = function() { return _size; };
      _this.indexOf = function(key) { return _map[key]; };
      _this.contains = function(key) { return typeof _map[key] != 'undefined'; };
      return _this;
    };
